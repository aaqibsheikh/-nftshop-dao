...
import {
  NFTSHOP_DAO_ABI,
  NFTSHOP_DAO_CONTRACT_ADDRESS,
  NFTSHOP_NFT_ABI,
  NFTSHOP_NFT_CONTRACT_ADDRESS,
} from "../constants";
...
export default function Home() {
  ...
  // User's balance of NFTShop NFTs
  ...
  // Reads the balance of the user's NFTShop NFTs and sets the `nftBalance` state variable
  const getUserNFTBalance = async () => {
    try {
      const signer = await getProviderOrSigner(true);
      const nftContract = getNFTShopNFTContractInstance(signer);
  ...
  // Helper function to return a NFTShop NFT Contract instance
  // given a Provider/Signer
  const getNFTShopNFTContractInstance = (providerOrSigner) => {
    return new Contract(
      NFTSHOP_NFT_CONTRACT_ADDRESS,
      NFTSHOP_NFT_ABI,
      providerOrSigner
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any NFTShop NFTs. <br />
  ...
  return (
    <div>
      <Head>
        <title>NFTShop DAO</title>
        <meta name="description" content="NFTShop DAO" />
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Your NFTShop NFT Balance: {nftBalance}
            <br />
